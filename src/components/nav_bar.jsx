...
import { logout, getUserAuthenticated } from "../services/authService";
      ...
      <div className="flex items-center gap-2">
        {isLoggedIn() && (
          <Link
            ...
            className={`flex items-center gap-2 rounded-lg p-2 text-sm transition-all hover:bg-accent ${
              location.pathname === "/home" ? "bg-accent font-medium" : ""
            }`}
          >
            Carros Disponíveis
          </Link>
        ...
        {isAdmin && (
          <Link
            to="/cadastro_carro"
            className={`flex items-center gap-2 rounded-lg p-2 text-sm transition-all hover:bg-accent ${
              location.pathname === "/cadastro_carro" ? "bg-accent font-medium" : ""
            }`}
          >
            Cadastrar Carro
          </Link>
